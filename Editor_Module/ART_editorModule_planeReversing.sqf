...
"Plane-reversing stuff (mission editor version)";
"Put this code inside of a Game Logic module in 3DEN, or in the initServer.sqf file";

ART_fnc_enablePlaneReversing_editorModule = {
    [[],{
        ART_fnc_initPlaneReversing = {
            ...
            "Setup functions for plane reversing";
                ...
                ART_fnc_reversePlanePulse = {
                    ...
                    if (_fwdVelocity > 0.5) exitWith {};
                    private _newFwdVelocity = -2;
                    if !(brakesDisabled _vehicle) then { _vehicle disableBrakes true; };
                ...
                ART_kbActionKeys_planeReversing = [31] + actionKeys "CarBack"; 'HeliDown';

                ART_fnc_handleKB_planeReversing = {
                    params ["_displayorcontrol", "_key", "_shift", "_ctrl", "_alt"];
                    'if (_shift or _ctrl or _alt) exitWith {};';
                    "Bind to car reverse (CarBack & Decrease Thrust)";
                    if !(_key in ART_kbActionKeys_planeReversing) exitWith {}; 
                ...
                ART_fnc_addKB_initPlaneReversing = {
                    ...
                    ART_EH_planeReversingHint = player addEventHandler ["GetInMan", {
                        ...
                        if (_vehicle isKindOf "Plane") then {
                            systemChat format ["TIP: Press %1 to reverse the plane (engine must be running).", actionKeysNames "CarBack"];
                        };
    ...
    }] remoteExec ["call", 0, 'ART_JIP_initPlaneReversing'];
};

call ART_fnc_enablePlaneReversing_editorModule;
